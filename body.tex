...
\begin{enumerate}
    \item
        A set of \emph{Milestones}, each of which represents the delivery of a major aspect of Rubin Operations or the availability of specific functionality. Milestones are officially defined in a \gls{Jira} milestone issue and are under change control.
        % Each planning package culminates in a milestone, and may contain other milestones describing intermediate results. 
        %(Amanda: A "Planning Package" was language used in the EVMS system of Construction and may not be relevant here)
    \item
        A series of \emph{epics} describe major pieces of work. 
        Epics are associated with concrete, albeit high-level, deliverables in the \gls{shape} of the above milestones, and have specific resource loads (staff assignments), start dates, durations, end dates. 
        All epics a linked to the milestone they are created to help deliver.  
\end{enumerate}
...
Level 1 milestones are achieved by the culmination effort defined by a set of Level 2 and Level 3 milestones. 
...
Level 2 milestones are achieved by the culmination effort defined by a set of Level 3 milestones.
Some Level 2 milestones may be reported to the agnecies as defined by the annual POP. 
\item[Level 3]
...
Some of these milestones are exposed to external reviewers (usually reserved for Level 1 milestones): it is vital that these be delivered on time and to specification.
...
\item
  ...
  \item
  Tagged with the appropriate L3 or L2 milestone that the epic will contribute to schieving (or achieve in its totality).
\end{itemize}
