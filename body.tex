...
\begin{enumerate}
    ...
    \item
        A series of \emph{epics} describe major pieces of work. Epics are associated with concrete, albeit high-level, deliverables in the \gls{shape} of the above milestones, and have specific resource loads (staff assignments), start dates, and durations.
\end{enumerate}
...
An example is the completion of an annual Data Release.
\item[Level 2]
