...
Figure~\ref{fig:annual-cycle} illustrates the phases of Rubin Operations budget development and spending planning throughout the year.
...
They are also invited to scrub their part of the risk register, and update their risk response plans in concert with their planned activities.
...
\subsection{Risk-aware Budgeting}
...
\subsection{Requests Beyond Target}
