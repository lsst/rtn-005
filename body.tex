...
2 & & Rubin Summit \gls{Operations}  \tabularnewline
  ...
  & 2.6 & \hspace{0.5cm} Summit Systems Engineering  \tabularnewline
3 & & Rubin Data Management \tabularnewline
  & 3.1 & \hspace{0.5cm} \gls{RDM} Management  \tabularnewline
  & 3.2 & \hspace{0.5cm} US Data Facility  \tabularnewline
  & 3.3 & \hspace{0.5cm} France Data Facility  \tabularnewline
  & 3.4 & \hspace{0.5cm} UK Data Facility \tabularnewline
  & 3.5 & \hspace{0.5cm} DevOps  \tabularnewline
  ...
  & 3.8 & \hspace{0.5cm} Campaign Management  \tabularnewline
  & 3.8 & \hspace{0.5cm} Service Quality and Reliability Engineering  \tabularnewline
  & 3.8 & \hspace{0.5cm} QServ  \tabularnewline
  & 3.8 & \hspace{0.5cm} Build Engineering  \tabularnewline
  & 3.8 & \hspace{0.5cm} Community Science  \tabularnewline
  & 3.8 & \hspace{0.5cm} Data Validation  \tabularnewline
...
Progress towards the highest level milestones is reported regularly throughout the fiscal year to \gls{SLAC}, \gls{AURA}, \gls{NSF} and \gls{DOE}.
...
Training, administrative, and outreach time is charged to either \gls{RSS} or \gls{ES} depending on where staff will move into \gls{NOIRLab} (\gls{RSS} or \gls{ES}).
