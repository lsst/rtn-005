...
In operations there is no \gls{Primavera} and no \gls{EVMS}.

\section{Useful Contacts}
\label{sec:contacts}

The \RO \gls{Director} is Robert Blum and the Deputy \gls{Director}  is Amanda Bauer.
...
Typically within \gls{DM}, a single \gls{CAM} is responsible for the whole of a third level \gls{WBS}.
...
defined for use within \gls{DM}, but even here properly adhering to the plan
