...
\gls{Rubin Operations} uses 1,726 hours per year as a fiducial value for effort estimation purposes. This figure is \emph{after} all vacations, sick leave, etc are taken into account. The \gls{Rubin Operations} partners, \gls{SLAC} and \gls{NOIRLab}, may have different definitions for tracking their staff time; 
