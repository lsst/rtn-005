    ...
    \begin{itemize}
       \item Next FY Milestone Review
          \begin{itemize}
             ...
             \item Import all changes into Jira as approved in Smartsheet
          \end{itemize}
...
\item The \texttt{Summary} is also the milestone title, and is a concise description of the when the milestone is reached.
...
\item The \texttt{Due Date} is the latest date in the future by which the milestone needs to be reached.
  This date should be before or the same as the milestone's parent milestone's ``Milestone Due Date'' as shown in the Smartsheet, or the ``Due Date'' of the parent milestone in Jira.
...
Where tickets describe bugs or other urgent emergent work which cannot be deferred, refer to \S\ref{sec:buket}.
