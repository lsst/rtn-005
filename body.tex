...
\item June-July: implement sandboxed changes.
   \begin{itemize}
      \item Implement proposed changes to Staffing Plan, \gls{Risk} Register, \gls{JIRA}/Smartsheet L2/L3 milestones
...
Level 1 and 2 milestones are under change control once they are defined and described in a \gls{JIRA} Milestone issue. Note the change control process is under development as a Pre-\gls{Operations} activity.
...
L1, L2 and most L3 milestones are defined as part of the annual planning \gls{cycle}, and prior to the year in which the work associated with them is due to be carried out. \glspl{AD} and Team Leaders communicate their milestones to the Program Coordinator, who enters them into Smartsheet and then creates a \gls{JIRA} issue of type ``milestone'' for each one.
...
Having defined the plan for a \gls{cycle} following \secref{sec:cycle-plan}, we (\gls{RDP} and \gls{RPF}) execute it by means of a series of month-long sprints.
