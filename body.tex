...
\item Preparation.
  ...
  Each team member should be assigned a plausible amount of work, based on the per-\gls{story} \gls{SP} estimates and the likely working rate of the developer (see \secref{sec:effort}).
...
and direct new recruits to them when they join your team\footnote{As per \secref{sec:newcomers}, remember that newcomers should be allocated \glspl{SP} for working through this material.}.
