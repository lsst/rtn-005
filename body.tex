...
\item
  ...
  Good practice here is to look at the milestone list in Smartsheet and choose an ID number that leads to a milestone ID that has not already been taken, and which roughly fits your milestone into the time-ordered list.  
\item
...
\item  
  The \texttt{POP Activity Description} text should contain one or maybe two sentences summarizing the activity needed to complete the milestone. 
...
\item
  The \texttt{POP Deliverable Description} is a very terse list of the deliverables needed to reach the Milestone. 
